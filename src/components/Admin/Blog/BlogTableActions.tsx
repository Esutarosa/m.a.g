...
import { deleteBlogById } from '@/config/actions/blog';
import Link from 'next/link';

interface BlogTableActionsProps { id: string }

const BlogTableActions: FC<BlogTableActionsProps> = ({ id }) => {
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align='end'>
        ...
        <DropdownMenuItem
          ...
          className='cursor-pointer flex items-center gap-2 focus:bg-destructive'
        >
          <RenderSVG
